...
const guardar = async (e) => {
    ...
    try {
        ...
        const url = '/MVC-2-2024/API/usuario/guardar';
...
const Buscar = async () => {
    ...
    const url = '/MVC-2-2024/API/usuario/buscar';
...
const Modificar = async (e) => {
    ...
    try {
        const body = new FormData(formulario)
        const url = '/MVC-2-2024/API/usuario/modificar';
...
const Eliminar = async (usuarios) => {
    ...
    if (confirmacion.isConfirmed) {
        ...
        try {
            ...
            const url = '/MVC-2-2024/API/usuario/eliminar';
            const config = {
                method: 'POST',
                body
            }

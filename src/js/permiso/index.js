...
const Buscar = async () => {
    ...
    const url = '/MVC-2-2024/API/permiso/buscar';
...
const guardar = async (e) => {
    ...
    try {
        ...
        const url = '/MVC-2-2024/API/permiso/guardar';
...
const Modificar = async (e) => {
    ...
    try {
        const body = new FormData(formulario)
        const url = '/MVC-2-2024/API/permiso/modificar';
...
const Eliminar = async (permiso) => {
    ...
    if (confirmacion.isConfirmed) {
        ...
        try {
            ...
            const url = '/MVC-2-2024/API/permiso/eliminar';
            const config = {
                method: 'POST',
                body
            }
